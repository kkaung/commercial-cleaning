...
const getItmes = (location: string) => {
    return [
        ...
        },
        {
            ...
            content: `We’ve got vetted end lease cleaners across ${location}, ready to help get you on the move.`,
        },
        {
        ...
        >
            <div className="space-y-1">
                ...
                <h2 className={headingVariants({})}>
                    More Than Just A Commercial Cleaning Service
                </h2>
            </div>
