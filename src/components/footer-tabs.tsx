                        ...
                        {tabs.map(tab => (
                            ...
                            >
                                <TabsTrigger
                                    value={tab.value}
                                    className={cn(
                                        'relative h-10 rounded-none border-b-2 border-b-transparent bg-transparent px-4 pb-4 pt-2 font-semibold text-muted-foreground shadow-none transition-none data-[state=active]:border-b-primary data-[state=active]:text-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none'
                                    )}
                                >
                                    {tab.title}
                                </TabsTrigger>
                                ...
                                >
                                    <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6">
                                        {l.items.map(i => (
                                            <li key={i.title}>
                                                <Link
                                                    href={`/commercial-cleaning-${l.title.toLowerCase()}/${
                                                        i.slug
                                                    }`}
                                    ...
                                    <div
                                        className={cn(
                                            'absolute z-10 bottom-0 inset-x-0 h-24 bg-gradient-to-t from-secondary via-secondary/80 translate-y-1',
                                            {
